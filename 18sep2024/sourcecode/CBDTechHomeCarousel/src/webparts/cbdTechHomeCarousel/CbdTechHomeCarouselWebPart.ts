...
export interface ICbdTechHomeCarouselWebPartProps {
  count: number;
  playspeed: number;
}

export default class CbdTechHomeCarouselWebPart extends BaseClientSideWebPart<ICbdTechHomeCarouselWebPartProps> {
