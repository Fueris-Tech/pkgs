...
export const Header: React.FunctionComponent<IHeader> = (props: IHeader) => {
    ...
    //     window.location.href = `${props.headerSiteUrl}/sitepages/notificationDetail.aspx?env=WebView&NId=${itemId}`;
    // }


    return (
        <div className="bg-white font-cairo max-w-xmdmax desktop:max-w-xlgmax large:max-w-lgmax  mx-auto ">
            <div className="flex gap-2 desktop:gap-4 items-center min-h-[88px]">
                <div className="grow">
                    ...
                    <a href={`${props.headerSiteUrl}?env=WebView`}><img src={logourl} alt="Commercial Bank of Dubai" width={200} height={50} /></a>
                </div>
                ...
                <div className="flex-none">
                    <div className="cursor-pointer relative bg-search flex items-center w-12 h-12 rounded-full overflow-hidden">
                        ...
                        <a className=" w-full h-full flex items-center justify-center" href={`${props.headerSiteUrl}/sitepages/search.aspx?env=WebView`} >
