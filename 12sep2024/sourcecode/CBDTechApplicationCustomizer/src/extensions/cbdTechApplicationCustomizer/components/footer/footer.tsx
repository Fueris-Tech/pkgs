...
export const Footer: React.FunctionComponent<IFooter> = (props: any) => {
    ...
    const logourl = `${props.footerSiteUrl}/SiteAssets/CBD/footer/logo.png`;
    ...
    return (<div className="bg-gray1">
        <div className="p-2 font-cairo max-w-xmdmax desktop:max-w-xlgmax large:max-w-lgmax  mx-auto ">
            <div className="flex gap-10 items-center min-h-[32px] text-white flex-wrap">
                <div className="flex-none">
                    ...
                    <a href={`${props.footerSiteUrl}?env=WebView`}><img src={logourl} alt="Commercial Bank of Dubai" width={180} height={50} /></a>
                </div>
                <div className="grow">
