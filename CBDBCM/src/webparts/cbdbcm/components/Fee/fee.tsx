                            ...
                            <div className="flex flex-col gap-6">
                                ...
                                <ul className="flex flex-col w-full gap-6">
                                    {feeItems
                                        ...
                                        .map(iit => (
                                            <li>
                                                <a className="block p-4 bg-white rounded-lg border-light border shadow-3xl text-base text-primary hover:font-bold" data-interception="off" rel="noopener noreferrer" target={iit.IsNew ? "_blank" : "_self"} href={iit.LinkToPage}>{iit.Title}</a>
                                            </li>
                                        ))}
                                </ul>
                            </div>
