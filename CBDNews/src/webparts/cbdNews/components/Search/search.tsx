                        ...
                        <div className="flex flex-wrap gap-4 w-full max-w-xmdmax desktop:max-w-xlgmax large:max-w-lgmax  mx-auto">
                            {news && news.map((n: any, index: number) => (
                                <div key={`search${index}`} className="bg-white h-1400 shadow-lg rounded-lg p-1 pb-8" style={{ maxWidth: 330, minWidth: 330 }}>
                                    <p className="pb-4">
                                        <a href={`${props.detailLink}?NewsId=${n.Id}`}><img src={n.Thumbnail_x0020_Photo.Url} className="w-full h-1220 object-cover rounded-lg" /></a>
                                    </p>
                                    ...
                                    <a className="text-lg px-2 mx-4 block text-gray1 overflow-hidden" title={n.Summary} href={`${props.detailLink}?NewsId=${n.Id}`}>
